...
/*if left_click_pressed events_add(name,"left_click_pressed_pressed")
if right_click_pressed events_add(name,"right_click_pressed_pressed")*/

if left_click_pressed count_start = true
